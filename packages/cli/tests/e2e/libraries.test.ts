...
module.exports = config;`;
    ...
    it('should import library tags using onImport configuration', () => {
        ...
        const importDir = join(
            MAIN_PROJECT_DIR,
            CONFIG_MAIN_PROJECT.import.dir
        );
        expect(
        ...
        expect(matches[0].translations.libraryHello).toEqual(
            'Hello from Library'
        );
