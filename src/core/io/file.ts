...
export async function $LT_EnsureDirectoryExists(
    filePath: string
): Promise<void> {
...
export async function $LT_WriteJSON(
    filePath: string,
    data: unknown
): Promise<void> {
...
export async function $LT_WriteFileWithDirs(
    filePath: string,
    content: string
): Promise<void> {
...
export async function $LT_ReadFileContent(
