...
import { reactProcessPlaceholders } from './react-process-placeholders-fn';
...
describe('reactProcessPlaceholders', () => {
  describe('Basic functionality', () => {
    ...
    it('should be case-sensitive with placeholder names', () => {
      const result = reactProcessPlaceholders('{{Name}} vs {{name}}', {
        Name: 'Alice',
        name: 'Bob',
      });
  ...
  describe('React components as placeholders', () => {
    it('should replace placeholders with React elements and return ReactNode array', () => {
      ...
      const result = reactProcessPlaceholders('Click {{button}} to continue', {
        button,
      });
    ...
    it('should handle multiple React components in the same string', () => {
      ...
      const result = reactProcessPlaceholders('Visit {{link}} and {{button}}', {
        link,
        button,
      });
    ...
    it('should handle React components with complex props', () => {
      ...
      const result = reactProcessPlaceholders('Notice: {{component}}', {
        component,
      });
    ...
    it('should handle React components with children', () => {
      ...
      const result = reactProcessPlaceholders('Text: {{component}}', {
        component,
      });
    ...
    it('should handle React fragments as placeholders', () => {
      ...
      const result = reactProcessPlaceholders('Content: {{fragment}}', {
        fragment,
      });
  ...
  describe('Mixed content (strings and React components)', () => {
    ...
    it('should handle string values that become React components in mixed scenarios', () => {
      ...
      const result = reactProcessPlaceholders('{{icon}} {{text}} {{icon}}', {
        icon,
        text: 'Hello',
      });
  ...
  describe('Edge cases and error conditions', () => {
    it('should return empty string if translation is not a string', () => {
      const result = reactProcessPlaceholders(12345 as any, { name: 'Alice' });
      expect(result).toBe('');
    });

    it('should return empty string if translation is null', () => {
      const result = reactProcessPlaceholders(null as any, { name: 'Alice' });
      expect(result).toBe('');
    });

    it('should return empty string if translation is undefined', () => {
      const result = reactProcessPlaceholders(undefined as any, {
        name: 'Alice',
      });
      expect(result).toBe('');
    });
    ...
    it('should handle empty placeholders', () => {
      const result = reactProcessPlaceholders('Hello {{}}!', { '': 'Empty' });
      expect(result).toBe('Hello Empty!');
    });

    it('should handle placeholders with special characters in names', () => {
      const result = reactProcessPlaceholders('Hello {{user-name}}!', {
        'user-name': 'Alice',
      });
      expect(result).toBe('Hello Alice!');
    });
    ...
    it('should handle placeholders with numbers in names', () => {
      const result = reactProcessPlaceholders('Item {{item1}} and {{item2}}', {
        item1: 'apple',
        item2: 'banana',
      });
    ...
    it('should handle placeholders with underscores in names', () => {
      const result = reactProcessPlaceholders('Hello {{user_name}}!', {
        user_name: 'Alice',
      });
      expect(result).toBe('Hello Alice!');
    });
  ...
  describe('Type safety and return value handling', () => {
    ...
    it('should return ReactNode array when any part is a React component', () => {
      const button = createElement('button', { key: 'btn' }, 'Click');
      const result = reactProcessPlaceholders('{{button}}', { button });
    ...
    it('should handle zero as a parameter value', () => {
      const result = reactProcessPlaceholders('Count: {{count}}', { count: 0 });
      expect(Array.isArray(result)).toBe(true);
  ...
  describe('Complex scenarios', () => {
    it('should handle very long placeholder names', () => {
      ...
      const result = reactProcessPlaceholders(`Hello {{${longKey}}}!`, {
        [longKey]: 'Alice',
      });
      expect(result).toBe('Hello Alice!');
    });
    ...
    it('should handle very long parameter values', () => {
      ...
      const result = reactProcessPlaceholders('Value: {{long}}', {
        long: longValue,
      });
    ...
    it('should handle string with only placeholders', () => {
      const result = reactProcessPlaceholders('{{greeting}}{{name}}', {
        greeting: 'Hello ',
        name: 'Alice',
      });
      expect(result).toBe('Hello Alice');
    ...
    it('should handle string with placeholders at the beginning and end', () => {
      const result = reactProcessPlaceholders('{{greeting}} middle {{name}}', {
        greeting: 'Hello',
        name: 'Alice',
      });
    ...
    it('should handle unicode characters in placeholder names', () => {
      const result = reactProcessPlaceholders('Hello {{имя}}!', {
        имя: 'Алиса',
      });
    ...
    it('should handle unicode characters in parameter values', () => {
      const result = reactProcessPlaceholders('Message: {{msg}}', {
        msg: 'Hello 世界! 🌍',
      });
    ...
    it('should handle emoji in placeholder names', () => {
      const result = reactProcessPlaceholders('Hello {{👋}}!', {
        '👋': 'wave',
      });
    ...
    it('should handle emoji in parameter values', () => {
      const result = reactProcessPlaceholders('Reaction: {{reaction}}', {
        reaction: '👍',
      });
  ...
  describe('React-specific edge cases', () => {
    it('should handle React components with null children', () => {
      ...
      const result = reactProcessPlaceholders('Content: {{component}}', {
        component,
      });
    ...
    it('should handle React components with function children', () => {
      const component = createElement('div', { key: 'div' }, 'Function result');
      const result = reactProcessPlaceholders('Content: {{component}}', {
        component,
      });
    ...
    it('should handle React components with complex nested structure', () => {
      ...
      const result = reactProcessPlaceholders('{{component}}', { component });
