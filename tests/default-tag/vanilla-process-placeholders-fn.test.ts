...
describe('processPlaceholders', () => {
  ...
  it('should handle very long parameter values', () => {
    ...
    const result = processPlaceholders('Value: {{long}}', { long: longValue });
  ...
  it('should handle string with literal double braces', () => {
    const result = processPlaceholders('This has literal {{ and }} braces', {
      name: 'Alice',
    });
  ...
  it('should handle decimal numbers as parameter values', () => {
    const result = processPlaceholders('Price: ${{price}}', { price: 19.99 });
