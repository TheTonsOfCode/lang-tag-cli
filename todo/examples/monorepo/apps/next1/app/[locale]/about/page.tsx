...
export default function AboutPage({ params }: AboutPageProps) {
  ...
  useEffect(() => {
    console.log(
      '[AboutPage] useEffect: current i18n.language:',
      i18n.language,
      'desired params.locale:',
      params.locale
    );
    setIsMounted(true);
    if (params.locale && i18n.language !== params.locale) {
      ...
      i18n.changeLanguage(params.locale).then(() => {
        console.log(
          '[AboutPage] useEffect: Language changed to',
          i18n.language,
          'Does it have pl common bundle?',
          i18n.hasResourceBundle('pl', 'common')
        );
      ...
      console.log(
        '[AboutPage] useEffect: No language change needed or params.locale is missing.'
      );
    }
  }, [params.locale, i18n]);
  ...
  console.log(
    '[AboutPage] Mounted, rendering. Current i18n.language for t():',
    i18n.language
  );
  return (
    <div>
